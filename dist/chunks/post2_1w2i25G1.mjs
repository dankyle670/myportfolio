import { c as createComponent, d as renderTemplate, e as renderComponent, u as unescapeHTML } from './astro_13fsRVDA.mjs';
import 'kleur/colors';
import 'clsx';
import { $ as $$LayoutBlogPost } from './LayoutBlogPost_sj7KI_t7.mjs';
...
const html = "<h1 id=\"hi-there\">Hi there!</h1>\n<p>This Markdown file creates a page at <code>your-domain.com/post1/</code></p>\n<p>It probably isn’t styled much, but Markdown does support:</p>\n<ul>\n<li><strong>bold</strong> and <em>italics.</em></li>\n<li>lists</li>\n<li><a href=\"https://astro.build\">links</a></li>\n<li>and more!</li>\n</ul>";
				...
				const file = "/home/dankyle/Documents/OWN_PROJ/professionel/my_portfolio/myportfolio/src/content/blog/post2.md";
				const url = undefined;
				function rawContent() {
